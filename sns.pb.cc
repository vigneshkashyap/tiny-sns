...
::uint8_t* ListReply::_InternalSerialize(
  ...
  for (int i = 0, n = this->_internal_all_users_size(); i < n; ++i) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        s.data(), static_cast<int>(s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "csce662.ListReply.all_users");
  ...
  for (int i = 0, n = this->_internal_followers_size(); i < n; ++i) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        s.data(), static_cast<int>(s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "csce662.ListReply.followers");
...
::uint8_t* Request::_InternalSerialize(
  ...
  if (!this->_internal_username().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "csce662.Request.username");
  ...
  for (int i = 0, n = this->_internal_arguments_size(); i < n; ++i) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        s.data(), static_cast<int>(s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "csce662.Request.arguments");
    target = stream->WriteString(2, s, target);
  }
...
::uint8_t* Reply::_InternalSerialize(
  ...
  if (!this->_internal_msg().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "csce662.Reply.msg");
...
::uint8_t* Message::_InternalSerialize(
  ...
  if (!this->_internal_username().empty()) {
    const std::string& _s = this->_internal_username();
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "csce662.Message.username");
    target = stream->WriteStringMaybeAliased(1, _s, target);
  }
  ...
  if (!this->_internal_msg().empty()) {
    const std::string& _s = this->_internal_msg();
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "csce662.Message.msg");
    target = stream->WriteStringMaybeAliased(2, _s, target);
  }
